...
# The set function will update the cache, i.e. "x" and "m". By setting a new matrix for computing  
# the inverse, x will be updated by being assigned to the new matrix and m becomes NULL which is a sign 
# for the cacheSove function, meaning that the cache should be updated and the new inverse matrix should
# be assigned to "m".
...
# The following function returns the inverse of "x". Actually cacheSolve keeps track of any modification 
# made to the the variable "m". If "m" is not NULL, it means that cache is up-to-date. But in case of 
# setting a new matrix for computing the inverse, "m" becomes NULL and part of cache, i.e. "m",will
# be updated by cacheSolve."m" will hold the inverse Matrix.
